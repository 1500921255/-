<template>
  <el-drawer title="我是标题" :visible.sync="drawer" @close="beforeClose" direction="ltr" :size="drawerSize"
    :with-header="false">
    ...
    <div class="block" style="margin:10px;">
      ...
      <el-timeline>
        <div class="blogsbox">
          <div v-for="item in subjectItemlist" :key="item.uid" class="blogs">
                  ...
                  <ul>
                    ...
                    <li class="lmname" v-if="item.blog.blogSort">
                      ...
                      <a href="javascript:void(0);"
                        @click="goToList(item.blog.blogSort.uid)">{{item.blog.blogSort.sortName}}</a>
                    </li>
                    <li class="view">
                      <span class="iconfont">&#xe8c7;</span>
